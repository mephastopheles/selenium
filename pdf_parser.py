...
class PDFParser:
    ...
    def __init__(self, filepath: str = ''):
        ...
        self.pdfFileObj = open(self.filepath, 'rb')
    ...
    def output_result(self):
        ...
        result = ''
        if self.text_per_page:
            for page in self.text_per_page:
                page_content = page[-1]
    ...
    def crop_image(self, element, pageObj: Any):
    ...
    def convert_to_images(self, input_file: str):
    ...
    def extraction_loop(self):
        ...
        for pagenum, page in enumerate(extract_pages(self.filepath)):
            ...
            for i, component in enumerate(page_elements):
                ...
                if not self.is_element_inside_any_table(element, page, tables):
                    ...
                    if isinstance(element, LTFigure):
                        ...
                        self.crop_image(self, element, pageObj)
                        # Convert the croped pdf to image
                        self.convert_to_images(self, 'cropped_image.pdf')
